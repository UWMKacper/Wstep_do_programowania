/* Cwiczenie_5.c -- Modyfikacja programu dodaj.c. Teraz probram oblicza
sume liczb calkowitych dla wartosci podanej przez uzytkownika*/
/* dodaj.c -- piec typow instrukcji */

#include <stdio.h>
#include <math.h>
int main(void)                      /* oblicza sume pierwszych liczb
calkowitych dla wartosci podanej przez uzytkownika                     */
{
